        ...
        <div class="container">
            <div class="col">
                ...
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col">
                        <h5 class="form-control bordenBoton card-title centrarTexto negritaTextoNosotros letraEB negritaLetra centrarTexto tamañoLetraActualiarPlato">DELIVERY</h5>
                    </div>
                    <div class="col-4"></div>
                    <div class="col">
                      <div class="col">
            ...
            <table class="table-rwd">
              ...
              <tbody>
                ...
                $sql = 'SELECT 
                  ...
                  C.Dirección AS C_Dirección   
                  
                  FROM Reserva R
                  INNER JOIN Cliente C
                  ON C.IdCliente = R.IdCliente
                  INNER JOIN Servicio S
                  ON R.IdServicio = S.IdServicio
                  WHERE S.IdServicio=4';
                ...
                if ($rows) {
                  foreach ($rows as $row) {
                    ...
                    <tr>
                      ...
                      <td>Pollada tradicional 1 x S/19.00
                      Ccapchi de queso 1 x S/10.00
                      Gaseosa de 2L 1 x S/10.00</td>
                      <td>39</td>
                      <td>41</td>
                      <td>
