                    ...
                    <div class="row">
                        <div class="col-4 p-0 bg-white">
                            <div class="d-grid gap-2">
                                <a class="btn btn-white border border-info" href="delivery-Platos.php" role="button">
                                    <b>Platos</b>
                        ...
                        <div class="col-4 p-0 bg-white">
                            <div class="d-grid gap-2">
                                <a class="btn btn-secondary text-white border border-info" href="delivery-Entrada.php" role="button">
                                    <b>Entrada</b>
